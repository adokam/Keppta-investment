...
export const Route = createFileRoute("/legal/terms")({
  head: () => seo({
    title: "Terms of Service — Kamdan",
    description: "Read the Kamdan Terms of Service governing use of our earning and investment platform.",
    path: "/legal/terms",
  }),
  component: () => (
    <LegalPage title="Terms of Service" updated="July 12, 2026">
      ...
      <h2>1. Eligibility</h2>
      <p>You must be at least 18 years old and a legal resident of Nigeria (or a supported jurisdiction) to use Kamdan. By registering, you confirm the information you provide is accurate and complete.</p>
      ...
      <ul>
        <li>Daily sign-in rewards (₦100 per day, ₦500 on day 7) are credited to your Kamdan balance upon successful check-in.</li>
      ...
      <p>All deposits and withdrawals are processed in Nigerian Naira (₦). Processing times and minimum limits may apply. Kamdan is not liable for delays caused by third-party payment providers or banks.</p>
      ...
      <h2>8. Disclaimer</h2>
      <p>Kamdan is provided "as is". Investment products carry risk — see our Risk Disclaimer for details. Past performance is not indicative of future results.</p>

      <h2>9. Limitation of Liability</h2>
      <p>To the maximum extent permitted by law, Kamdan and its affiliates are not liable for indirect, incidental, or consequential damages arising from your use of the platform.</p>

...
export const Route = createFileRoute("/legal/disclaimer")({
  head: () => seo({
    title: "Risk Disclaimer — Kamdan",
    description: "Understand the risks of using Kamdan's investment and earning products.",
    path: "/legal/disclaimer",
  }),
  component: () => (
    <LegalPage title="Risk Disclaimer" updated="July 12, 2026">
      <p>The information on Kamdan is for general purposes only and does not constitute financial, investment, tax, or legal advice.</p>
      ...
      <p>We rely on banks, payment gateways, and telecom providers. Kamdan is not responsible for outages, delays, or errors caused by these third parties.</p>

      <h2>4. Your Responsibility</h2>
      <p>You are responsible for tax reporting on any earnings from Kamdan under applicable Nigerian tax law.</p>

...
export const Route = createFileRoute("/")({
  head: () => {
    const s = seo({
      title: "Kamdan — Earn Daily, Invest Smart in Nigeria",
      description: "Sign in to Kamdan. Earn ₦100 every day (₦500 on day 7), complete tasks, refer friends and grow your income.",
      path: "/",
    });
    return {
      ...s,
